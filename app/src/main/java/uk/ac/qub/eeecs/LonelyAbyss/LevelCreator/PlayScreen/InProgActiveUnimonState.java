...
public class InProgActiveUnimonState extends State {
    ...
    public InProgActiveUnimonState(ScreenViewport mScreenViewport, LayerViewport mLayerViewPort, Game mGame, GameScreen mGameScreen, Boolean active) {
